...
namespace scene {
	...
	Color periwinkle(199.0f / 255.0f, 206.0f / 255.0f, 234.0f / 255.0f, .0f);
	...
	glm::vec3 boxMid(.4f, -.75f, -2.3f);
	glm::vec3 boxMid2(-.4f, -.75f, -1.5f);

	//Box box(
	//	 glm::vec3(boxMid.x + 0.15f, boxMid.y + .15f, boxMid.z - 0.15f), glm::vec3(boxMid.x - 0.15f, boxMid.y - .15f, boxMid.z + 0.15f),
	//	green, DIFFUSE); 
	Box box(glm::vec3(boxMid.x - 0.25f, boxMid.y + .25f, boxMid.z - .25f),
		glm::vec3(boxMid.x + 0.25f, boxMid.y - 0.25f, boxMid.z + 0.25f), 
		pastel_pink, REFLECTION_AND_REFRACTION);

	Box box2(glm::vec3(boxMid2.x - 0.25f, boxMid2.y + .25f, boxMid2.z - .25f),
